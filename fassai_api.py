...
class WebScrapping:
    ...
    web = webdriver.Firefox(executable_path=r'C:\\geckodriver.exe')
    ...
    def Get_Detail_form(self):
        ...
        for item in Get_detail:
            ...
            if(company_detail == "View Products"):
                try:
                    self.web.find_element_by_link_text('View Products').click()
                    ...
                    if(get_list_product_len<=1):
                        ...
                        get_product_data = self.web.find_elements_by_xpath(path3).click()
                        a = []
